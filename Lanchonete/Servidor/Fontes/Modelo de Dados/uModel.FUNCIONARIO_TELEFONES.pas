     ...
     //Criando tabelas...
      ...
      begin 
        ...
        begin 
          ...
          Add('COMMENT ON COLUMN FUNCIONARIO_TELEFONES.ID_FUNCIONARIO IS ''CÃ“DIGO DO FUNCIONARIO'';');
          ...
          Add('COMMENT ON COLUMN FUNCIONARIO_TELEFONES.ID_USUARIO IS ''CÃ“DIGO DO USUÃRIO'';');
...
begin 
  try 
    try 
      ...
      if FTIPO = -1 then 
        raise Exception.Create('TIPO: TIPO DO FUNCIONARIO: 0-TELEFONE COMERCIAL, 1-CELULAR, 2-TELEFONE RESIDENCIAL não informado'); 
      if FNUMERO = '' then 
