...
begin
  case TRectangle(Sender).Tag of
    0:FFancyDialog.Show(TIconDialog.Question,'Pagamento','Cancela o Pagamento?','Sim',CancelaPagamento,'Não');
...
begin
  case TRectangle(Sender).Tag of
    0:FFancyDialog.Show(TIconDialog.Question,'','Baixar horas?','SIM',BaixarHoras,'NÃO');
