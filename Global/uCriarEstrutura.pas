...
begin
  ...
  begin
    ...
    lQuery_Objeto.Connection := DM_Lanchonete.FDC_Lanchonete;
    ...
    {$Region 'Seção privada'}
      ...
      lString.Add('    ');
      DM_Lanchonete.Listar_Campos(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex]);
    ...
    {$Region 'Seção publica'}
      ...
      DM_Lanchonete.Listar_PrimaryKey(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex],'');
      if not lQuery_Objeto.IsEmpty then
    ...
    {$Region 'Procedure Criar_Estrutura'}
      ...
      DM_Lanchonete.Listar_Indices(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex],'');
      if not lQuery_Objeto.IsEmpty then
      begin
        lQuery_Objeto.First;
        while not lQuery_Objeto.Eof do
      ...
      lString.Add(' ');
      DM_Lanchonete.Listar_Triggers(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex],'');
      if not lQuery_Objeto.IsEmpty then
      begin
        lQuery_Objeto.First;
        while not lQuery_Objeto.Eof do
      ...
      lString.Add(' ');
      DM_Lanchonete.Listar_Generator(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex],'');
      if not lQuery_Objeto.IsEmpty then
      begin
        lQuery_Objeto.First;
        while not lQuery_Objeto.Eof do
      ...
      //Foreing key
      DM_Lanchonete.Listar_ForeingKey(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex],'');
      if not lQuery_Objeto.IsEmpty then
      begin
        lQuery_Objeto.First;
        while not lQuery_Objeto.Eof do
...
begin
  ...
  begin
    ...
    {$Region 'Listar'}
      ...
      lString.Add(' ');
      lString.Add('  DM_Lanchonete :TDM_Lanchonete; ');
      ...
      lString.Add(' ');
      //Chave primaria
      DM_Lanchonete.Listar_Filtros(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex]);
      if not lQuery_Objeto.IsEmpty then
      begin
        lQuery_Objeto.First;
        while not lQuery_Objeto.Eof do
      ...
      lString.Add('  try ');
      lString.Add('    try ');
      lString.Add('      DM_Lanchonete := TDM_Lanchonete.Create(Nil); ');
      lString.Add(' ');
      lString.Add('      lT'+cbTabela.Items.Strings[cbTabela.ItemIndex]+' := T'+cbTabela.Items.Strings[cbTabela.ItemIndex]+'.Create(DM_Lanchonete.FDC_Lanchonete); ');
      lString.Add('      lQuery := TFDQuery.Create(Nil); ');
      lString.Add('      lQuery.Connection := DM_Lanchonete.FDC_Lanchonete; ');
      lString.Add(' ');
      //Chave primária
      DM_Lanchonete.Listar_Filtros(lQuery_Objeto,cbTabela.Items.Strings[cbTabela.ItemIndex]);
      if not lQuery_Objeto.IsEmpty then
    ...
    {$Region 'Cadastrar'}
      ...
      lString.Add('    try ');
      lString.Add('      DM_Lanchonete := TDM_Lanchonete.Create(Nil); ');
      lString.Add('      if not DM_Lanchonete.FDC_Lanchonete.InTransaction then ');
      lString.Add('        DM_Lanchonete.FDC_Lanchonete.StartTransaction; ');
      lString.Add(' ');
      lString.Add('      lT'+cbTabela.Items.Strings[cbTabela.ItemIndex]+' := T'+cbTabela.Items.Strings[cbTabela.ItemIndex]+'.Create(DM_Lanchonete.FDC_Lanchonete); ');
      lString.Add('      lQuery := TFDQuery.Create(Nil); ');
      lString.Add('      lQuery.Connection := DM_Lanchonete.FDC_Lanchonete; ');
      ...
      lString.Add('      end; ');
      lString.Add(' ');
      lString.Add('      DM_Lanchonete.FDC_Lanchonete.Commit; ');
      lString.Add(' ');
      ...
      lString.Add('    except on E: Exception do ');
      lString.Add('      begin ');
      lString.Add('        DM_Lanchonete.FDC_Lanchonete.Rollback; ');
      lString.Add('        Res.Send(E.Message).Status(500); ');
