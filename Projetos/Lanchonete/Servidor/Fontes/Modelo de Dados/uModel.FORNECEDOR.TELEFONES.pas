     ...
     //Criando tabelas...
      ...
      begin
        ...
        begin
          ...
          Add('COMMENT ON COLUMN FORNECEDOR_TELEFONES.ID_FORNECEDOR IS ''CÃ“DIGO DO FORNECEDOR'';');
          ...
          Add('COMMENT ON COLUMN FORNECEDOR_TELEFONES.ID_USUARIO IS ''CÃ“DIGO DO USUÃRIO'';');
...
begin
  try
    try
      ...
      if FTIPO = -1 then
        raise Exception.Create('TIPO: TIPO DO FORNECEDOR: 0-TELEFONE COMERCIAL, 1-CELULAR, 2-TELEFONE RESIDENCIAL não informado');
      if FNUMERO = '' then
      ...
      if FID_FORNECEDOR = 0 then
        raise Exception.Create('FID_FORNECEDOR: CÓDIGO DA FORNECEDOR não informado');
