  ...
  try
    try
      ...
      begin
        ...
        TFuncoes.Gravar_Hitorico(lQuery,'Telefones do Cliente não localizado');
      end
      else
      begin
...
begin
  try
    try
      ...
      Res.Send('Telefone do Cliente excluído').Status(200);
      TFuncoes.Gravar_Hitorico(lQuery,'Telefone do Cliente excluído');
    except on E: Exception do
      begin
        Res.Send(E.Message).Status(500);
