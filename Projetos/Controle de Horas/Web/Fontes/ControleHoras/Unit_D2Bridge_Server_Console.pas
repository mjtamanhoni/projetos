...
uses
  ...
  ControleHorasWebApp, Unit_Login;
...
begin
 D2BridgeServerController:= TControleHorasWebAppGlobal.Create(TApplication.Create(nil));
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(3001);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('D2Bridge Server');

 D2BridgeServerController.APPName:= 'ControleHoras';
