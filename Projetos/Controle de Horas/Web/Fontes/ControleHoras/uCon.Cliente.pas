...
type
  TfrmCon_Cliente = class(TD2BridgeForm)
...
begin
  ControleHoras.Cliente_ID := 0;
  ControleHoras.Cliente_Nome := '';
  if not FDMem_Registro.IsEmpty then
  begin
    ControleHoras.Cliente_ID := FDMem_RegistroID.AsInteger;
    ControleHoras.Cliente_Nome := FDMem_RegistroNOME.AsString;
  end;
