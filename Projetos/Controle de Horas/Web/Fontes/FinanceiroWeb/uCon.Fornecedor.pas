...
begin
  FinanceiroWeb.Fornecedor_ID := 0;
  FinanceiroWeb.Fornecedor_Nome := '';
  if not FDMem_Registro.IsEmpty then
  begin
    FinanceiroWeb.Fornecedor_ID := FDMem_RegistroID.AsInteger;
    FinanceiroWeb.Fornecedor_Nome := FDMem_RegistroNOME.AsString;
  end;
end;
