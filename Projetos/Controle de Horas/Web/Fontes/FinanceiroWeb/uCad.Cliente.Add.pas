...
begin
  ...
  if FinanceiroWeb.Fornecedor_ID > 0 then
  begin
    edID_FORNECEDOR.Text := IntToStr(FinanceiroWeb.Fornecedor_ID);
    edFORNECEDOR.Text := FinanceiroWeb.Fornecedor_Nome;
  end;
...
begin
  ...
  begin
    edID_TAB_PRECO.Text := IntToStr(FinanceiroWeb.Tab_Preco_ID);
    edTAB_PRECO.Text := FinanceiroWeb.Tab_Preco_Nome;
  end;
