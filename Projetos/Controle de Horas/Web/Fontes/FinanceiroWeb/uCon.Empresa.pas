...
uses
  ...
  FireDAC.DApt.Intf, Data.DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, Vcl.ExtCtrls, Vcl.Grids, Vcl.DBGrids, cxGraphics,
  cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxSkinsCore, dxSkinBasic, dxSkinBlack, dxSkinBlue, dxSkinBlueprint,
  ...
  dxSkinOffice2019Black, dxSkinOffice2019Colorful, dxSkinOffice2019DarkGray, dxSkinOffice2019White, dxSkinPumpkin, dxSkinSeven,
  ...
  dxSkinVisualStudio2013Light, dxSkinVS2010, dxSkinWhiteprint, dxSkinWXI, dxSkinXmas2008Blue, cxStyles, cxCustomData, cxFilter,
  cxData, cxDataStorage, cxEdit, cxNavigator, dxDateRanges, dxScrollbarAnnotations, cxDBData, cxGridLevel, cxClasses,
  cxGridCustomView, cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxGrid;

type
  TfrmCon_Empresa = class(TfrmPrincipal)
...
function frmCon_Empresa:TfrmCon_Empresa;
...
function frmCon_Empresa:TfrmCon_Empresa;
begin
  result:= TfrmCon_Empresa(TfrmCon_Empresa.GetInstance);
end;

procedure TfrmCon_Empresa.btConfirmarClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmCon_Empresa.btPesquisarClick(Sender: TObject);
begin
  Pesquisar;
end;

procedure TfrmCon_Empresa.ExportD2Bridge;
begin
  inherited;

  Title:= 'Consuta de Empresas';
...
procedure TfrmCon_Empresa.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmCon_Empresa.FormCreate(Sender: TObject);
begin
  FEnder  := '';
...
procedure TfrmCon_Empresa.FormShow(Sender: TObject);
begin
  Pesquisar;
end;

procedure TfrmCon_Empresa.InitControlsD2Bridge(const PrismControl: TPrismControl);
begin
 inherited;
...
procedure TfrmCon_Empresa.Pesquisar;
var
  FResp :IResponse;
  FBody :TJSONArray;
...
procedure TfrmCon_Empresa.RenderD2Bridge(const PrismControl: TPrismControl; var HTMLControl: string);
begin
 inherited;
