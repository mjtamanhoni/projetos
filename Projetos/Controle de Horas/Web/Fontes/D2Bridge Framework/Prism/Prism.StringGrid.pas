...
constructor TPrismStringGrid.Create(AOwner: TComponent);
var
...
begin
 ...
 try
   if Assigned(FDataLink) then
     vJSONData:= FDataLink.StringGridToJson(Columns.ColumnsNameToJSON, MaxRecords, Session.FormatSettings, true).ToJSON;
 except
