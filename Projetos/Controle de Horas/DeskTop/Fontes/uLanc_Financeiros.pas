...
type
  ...
  TfrmLanc_Financeiros = class(TForm)
    ...
    FDQRegistrosorigem_lancamento: TWideStringField;
    ...
    FDQRegistrosdesconto_baixa: TBCDField;
    FDQRegistrosjuros_baixa: TBCDField;
    FDQRegistrosvalor_baixa: TBCDField;
    ...
    FDQRegistrostipo_conta_desc: TWideMemoField;
    FDQRegistrospessoa: TWideStringField;
    FDQRegistrosstatus_desc: TWideMemoField;
    FDQRegistrosusuario: TWideStringField;
    ...
    try
      ...
      case FTab_Status of
        dsInsert :begin
          FQuery.Active := False;
          FQuery.SQL.Clear;
          FQuery.SQL.Add('select nextval(''lancamentos_id_seq'') as seq;');
          FQuery.Active := True;
          if not FQuery.IsEmpty then
