...
type
  ...
  TfrmPesq_Pessoas = class(TForm)
    ...
    FDQRegistrostipo: TWideMemoField;
    FDQRegistrosid: TIntegerField;
    FDQRegistrosnome: TWideStringField;
    FDQRegistrospessoa: TIntegerField;
    FDQRegistrosdocumento: TWideStringField;
    FDQRegistrosinsc_est: TWideStringField;
    FDQRegistrosendereco: TWideStringField;
    FDQRegistroscomplemento: TWideStringField;
    FDQRegistrosnumero: TWideStringField;
    FDQRegistrosbairro: TWideStringField;
    FDQRegistroscidade: TWideStringField;
    FDQRegistrosuf: TWideStringField;
    FDQRegistrostelefone: TWideStringField;
    FDQRegistroscelular: TWideStringField;
    FDQRegistrosemail: TWideStringField;
    FDQRegistrosid_tab_preco: TIntegerField;
    FDQRegistrospessoa_desc: TWideMemoField;
...
begin
  ...
  begin
    ...
    FDQRegistros.SQL.Add('FROM (SELECT ');
    ...
    FDQRegistros.SQL.Add('      FROM FORNECEDOR F) C ');
