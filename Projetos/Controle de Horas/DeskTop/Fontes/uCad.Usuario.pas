...
type
  ...
  TfrmCad_Usuario = class(TForm)
    ...
    FDQRegistrosnome: TWideStringField;
    FDQRegistroslogin: TWideStringField;
    FDQRegistrossenha: TWideStringField;
    FDQRegistrospin: TWideStringField;
    FDQRegistroscelular: TWideStringField;
    FDQRegistrosemail: TWideStringField;
    FDQRegistrosid_empresa: TIntegerField;
    FDQRegistrosid_prestador_servico: TIntegerField;
    FDQRegistrosid_cliente: TIntegerField;
    FDQRegistrosfoto: TBlobField;
    FDQRegistrosform_inicial: TWideStringField;
    ...
    FDQRegistrosprestador_servico: TWideStringField;
    ...
    dxfmGrid1RootLevel1login: TdxfmGridColumn;
    dxfmGrid1RootLevel1senha: TdxfmGridColumn;
    dxfmGrid1RootLevel1pin: TdxfmGridColumn;
    ...
    dxfmGrid1RootLevel1foto: TdxfmGridColumn;
    dxfmGrid1RootLevel1form_inicial: TdxfmGridColumn;
    dxfmGrid1RootLevel1dt_cadastro: TdxfmGridColumn;
    dxfmGrid1RootLevel1hr_cadastro: TdxfmGridColumn;
    dxfmGrid1RootLevel1sincronizado: TdxfmGridColumn;
    dxfmGrid1RootLevel1empresa: TdxfmGridColumn;
    dxfmGrid1RootLevel1prestador_servico: TdxfmGridColumn;
