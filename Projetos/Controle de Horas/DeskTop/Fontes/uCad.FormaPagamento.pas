...
type
  ...
  TfrmFormaPagamento = class(TForm)
    ...
    FDQRegistrosclassificacao: TWideStringField;
    FDQRegistrosdt_cadastro: TDateField;
    FDQRegistroshr_cadastro: TTimeField;
    FDQCondicaoid: TIntegerField;
    FDQCondicaoid_forma_pagamento: TIntegerField;
    FDQCondicaoid_condicao_pagamento: TIntegerField;
    FDQCondicaodt_cadastro: TDateField;
    FDQCondicaohr_cadastro: TTimeField;
    FDQCondicaocondicao: TWideStringField;
    ...
    FDQ_Condicao_Gridcondicao: TWideStringField;
