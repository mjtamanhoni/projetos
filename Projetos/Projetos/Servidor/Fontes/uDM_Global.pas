...
procedure TDM.FDC_ServidorBeforeConnect(Sender: TObject);
begin
  CarregarConfigDB(FDC_Servidor);
end;

procedure TDM.Listar_Campos(const AQuery: TFDQuery; const ATabela,  ACampo: String);
begin
  try
    try
...
procedure TDM.Listar_Filtros(const AQuery: TFDQuery; const ATabela: String);
begin
  try
    try
      AQuery.Connection := FDC_Servidor;
...
procedure TDM.Listar_ForeingKey(const AQuery: TFDQuery; const ATabela,
  AForeingKey: String);
begin
  try
    try
...
procedure TDM.Listar_Generator(const AQuery: TFDQuery; const ATabela,
  AGenerator: String);
begin
  try
    try
...
procedure TDM.Listar_Indices(const AQuery: TFDQuery; const ATabela,
  AIndice: String);
begin
  try
    try
...
procedure TDM.Listar_PrimaryKey(const AQuery: TFDQuery; const ATabela,
  APrimaryKey: String);
begin
  try
    try
...
procedure TDM.Listar_Tabelas(const AQuery: TFDQuery; const ATabela: String);
begin
  try
    try
      AQuery.Connection := FDC_Servidor;
...
procedure TDM.Listar_Triggers(const AQuery: TFDQuery; const ATabela,
  ATrigger: String);
begin
  try
    try
