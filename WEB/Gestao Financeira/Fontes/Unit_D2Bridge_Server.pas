...
uses
  ...
  Gestao_FinanceiraWebApp, Vcl.Menus;
...
begin
 ...
 D2BridgeServerController.APPName:= 'Gestão Financeira';
...
begin
 D2BridgeServerController:= TGestao_FinanceiraWebAppGlobal.Create(Application);
