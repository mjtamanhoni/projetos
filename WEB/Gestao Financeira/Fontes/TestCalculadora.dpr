...
uses
  System.SysUtils,
  uCalculadoraExpressao in 'uCalculadoraExpressao.pas',
  uExemploCalculadora in 'uExemploCalculadora.pas';
...
begin
  try
    WriteLn('=== TESTE DA CALCULADORA DE EXPRESSÕES ===');
    WriteLn;
