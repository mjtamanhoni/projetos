...
type
  TfrmUsuarios_Loc = class(TD2BridgeForm)
...
function frmUsuarios_Loc:TfrmUsuarios_Loc;
...
function frmUsuarios_Loc:TfrmUsuarios_Loc;
begin
  result:= TfrmUsuarios_Loc(TfrmUsuarios_Loc.GetInstance);
end;

procedure TfrmUsuarios_Loc.btCancelarClick(Sender: TObject);
begin
  {$Region 'Retornando valores'}
    Gestao_Financeira.Usuario_ID := 0;
    Gestao_Financeira.Usuario_Nome := '';
    Gestao_Financeira.Usuario_Tipo := -1;
    Gestao_Financeira.Usuario_Status := -1;
    Gestao_Financeira.Usuario_Login := '';
    Gestao_Financeira.Usuario_Email := '';
  {$Region 'Retornando valores'}
...
procedure TfrmUsuarios_Loc.btConfirmarClick(Sender: TObject);
begin
  {$Region 'Retornando valores'}
    Gestao_Financeira.Usuario_ID := FDMem_Registroid.AsInteger;
    Gestao_Financeira.Usuario_Nome := FDMem_Registronome.AsString;
    Gestao_Financeira.Usuario_Tipo := FDMem_Registrotipo.AsInteger;
    Gestao_Financeira.Usuario_Status := FDMem_Registrostatus.AsInteger;
    Gestao_Financeira.Usuario_Login := FDMem_Registrologin.AsString;
    Gestao_Financeira.Usuario_Email := FDMem_Registroemail.AsString;
  {$Region 'Retornando valores'}
...
procedure TfrmUsuarios_Loc.edPesquisarRightButtonClick(Sender: TObject);
begin
  Pesquisar;
end;

procedure TfrmUsuarios_Loc.ExportD2Bridge;
begin
  inherited;

  Title:= 'Localiza Usuário';
...
procedure TfrmUsuarios_Loc.FormCreate(Sender: TObject);
begin
...
procedure TfrmUsuarios_Loc.FormShow(Sender: TObject);
begin
...
procedure TfrmUsuarios_Loc.InitControlsD2Bridge(const PrismControl: TPrismControl);
begin
 inherited;
...
procedure TfrmUsuarios_Loc.Pesquisar;
var
  FResp :IResponse;
  FBody :TJSONArray;
...
procedure TfrmUsuarios_Loc.RenderD2Bridge(const PrismControl: TPrismControl; var HTMLControl: string);
begin
 inherited;
