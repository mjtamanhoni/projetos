...
type
  TfrmRegioes_Loc = class(TD2BridgeForm)
...
function frmRegioes_Loc:TfrmRegioes_Loc;
...
function frmRegioes_Loc:TfrmRegioes_Loc;
begin
  result:= TfrmRegioes_Loc(TfrmRegioes_Loc.GetInstance);
end;

procedure TfrmRegioes_Loc.btCancelarClick(Sender: TObject);
begin
  {$Region 'Retornando valores'}
    Gestao_Financeira.Regiao_ID := 0;
    Gestao_Financeira.Regiao_IBGE := 0;
    Gestao_Financeira.Regiao_Nome := '';
  {$Region 'Retornando valores'}
...
procedure TfrmRegioes_Loc.btConfirmarClick(Sender: TObject);
begin
  {$Region 'Retornando valores'}
    Gestao_Financeira.Regiao_ID := FDMem_Registroid.AsInteger;
    Gestao_Financeira.Regiao_IBGE := FDMem_Registroibge.AsInteger;
    Gestao_Financeira.Regiao_Nome := FDMem_Registronome.AsString;
  {$Region 'Retornando valores'}
...
procedure TfrmRegioes_Loc.edPesquisarRightButtonClick(Sender: TObject);
begin
  Pesquisar;
end;

procedure TfrmRegioes_Loc.ExportD2Bridge;
begin
  inherited;

  Title:= 'Localiza Regiões Brasileiras';
...
procedure TfrmRegioes_Loc.FormCreate(Sender: TObject);
begin
...
procedure TfrmRegioes_Loc.FormShow(Sender: TObject);
begin
  Pesquisar;
end;

procedure TfrmRegioes_Loc.InitControlsD2Bridge(const PrismControl: TPrismControl);
begin
 inherited;
...
procedure TfrmRegioes_Loc.Pesquisar;
var
  FResp :IResponse;
  FBody :TJSONArray;
...
procedure TfrmRegioes_Loc.RenderD2Bridge(const PrismControl: TPrismControl; var HTMLControl: string);
begin
 inherited;
