...
type
  ...
  TfrnPrincipal = class(TD2BridgeForm)
  ...
  Function frnPrincipal: TfrnPrincipal;
...
Function frnPrincipal: TfrnPrincipal;
begin
 Result:= (TfrnPrincipal.GetInstance as TfrnPrincipal);
end;

procedure TfrnPrincipal.Module11Click(Sender: TObject);
begin
  frnPrincipal.Show;
end;

procedure TfrnPrincipal.ExportD2Bridge;
begin
  inherited;
...
procedure TfrnPrincipal.InitControlsD2Bridge(const PrismControl: TPrismControl);
begin
  inherited;
...
procedure TfrnPrincipal.RenderD2Bridge(const PrismControl: TPrismControl;
